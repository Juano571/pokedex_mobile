      ...
      appBar: AppBar(
        actions: [
          IconButton(onPressed: () {
            Provider.of<CategoryProvider>(context,listen: false).initializeCategories();
        ...
        children: [
          Padding(
            ...
            child: SizedBox(
              ...
              height: 40,
              child: Card(elevation: 10, child: Text('Ultima sinconización: $lastUpdate')),
            ),
          ),
